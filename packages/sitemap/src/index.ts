import { defineIntegration, execLibHookSync, hookProviderPlugin } from '@demo/helpers';
					...
					addIntegration(params, {
						integration: sitemap({
							...
							filter: (page) => {
								...
								// Or without the AIK plugin
								execLibHookSync(params.config.integrations, 'sitemap:pageCandidate', {
									page,
									omitPage: () => {
										keepPage = false;
									},
